...
<Link href='https://olive-kelcey-53.tiiny.site/' target='_blank'>
     ...
     <div data-aos="fade-left" className='lg:w-[500px] mx:auto md:mx-0 mt-[2.5rem] lg:mt-0 lg:h-[500px] w-[300px] h-[300px] relative'>
        <Image src="/images/camera.png" alt='user' layout='fill' objectFit='contain' className='relative z-[11] w-[100%] h-[100%] object-contain'/>
        <div className='absolute w-[87%]  h-[100%] z-[10] bg-[#55e6a5] top-[-3rem] right-[2rem]'></div>
     </div>
   </div>
  </div>
  );
