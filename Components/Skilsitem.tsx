...
const Skilsitem = ({title,year,institues,place}:Props) => {
  return (
    <div className='mb-[4rem] md:mb-[8rem]'>
      ...
      <p className='text-[#aaaa] font-normal w-[80%] text-[17px] opacity-80' >{institues}</p>
      <p className='text-[#aaaa] font-normal w-[80%] text-[17px] opacity-80' >{place}</p>
    </div>
  )
}
